...
Starts Gazebo, Betaflight SITL, the bridge, and optionally the RC takeoff test.

Options:
  --headless          Run Gazebo server-only with -r -s.
  --no-rc            Start Gazebo, SITL, and bridge, but do not send RC.
...
echo
echo "Press Ctrl+C here to stop Gazebo, SITL, bridge, and RC."
